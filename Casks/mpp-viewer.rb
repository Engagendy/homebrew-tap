cask "mpp-viewer" do
  version "2.6.2"
  sha256 "c2d09a7395617ed8ff5874b1e1dceccf88d9726f0db2ed16f34f94707b5dc4ac"

  url "https://github.com/Engagendy/MPPViewerMacOS/releases/download/v2.6.2/MPPViewer-#{version}-arm64.dmg",
